...
function Show-Help {
    Write-Host "Usage: .\shelbot.ps1 <model|command> [options]"
    Write-Host ""
    ...
    Write-Host "  -CheckUpdates             Check for and install Windows updates, then provide an analysis using ShelBot."
